...
const CANONICAL_DEFAULTS = defaultDealTerms({ iba_usd: 1, maturity_months: 12 });
...
export function CalculatorEmbed({ persona, onPersonaChange }: CalculatorEmbedProps) {
  ...
  const [floorMultiple, setFloorMultiple] = useState(
    () => CANONICAL_DEFAULTS.floor_multiple.toString()
  );
  const [ceilingMultiple, setCeilingMultiple] = useState(
    () => CANONICAL_DEFAULTS.ceiling_multiple.toString()
  );
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="gate-floor"
                      inputMode="decimal"
                      placeholder={CANONICAL_DEFAULTS.floor_multiple.toString()}
                      value={floorMultiple}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="gate-ceiling"
                      inputMode="decimal"
                      placeholder={CANONICAL_DEFAULTS.ceiling_multiple.toString()}
