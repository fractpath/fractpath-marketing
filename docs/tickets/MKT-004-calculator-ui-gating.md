**Status: SPLIT → see WGT-030 + WGT-031 + remaining marketing work**
...
- **WGT-030** covers calculator UI shell (inputs, outputs layout, chart container) inside the widget.
- **WGT-031** covers gating/blur behavior and email gate UX inside the widget.
- **Marketing retains:** wrapper/layout component (`<CalculatorEmbed />`), page-level section scaffolding, persona tab integration, and query param parsing.
